...
int main(){
	...
	fptr=fopen("/home/Desktop/C/random number generates and sorts them into twto text file/random.txt", "w");
	...
	fptr2=fopen("/home/Desktop/C/random number generates and sorts them into twto text file/sorted_random.txt", "w");
